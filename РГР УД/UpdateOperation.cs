...
namespace РГР_УД
{
    public partial class UpdateOperation : Form
    {
        ...
        private void updateButton_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("UPDATE @table SET @attr = 'Электронный' WHERE @table.@attr = @value;", DB.getConnection());

            command.Parameters.Add("@adminLogin", MySqlDbType.VarChar).Value = table;
            command.Parameters.Add("@adminPassword", MySqlDbType.VarChar).Value = table;
