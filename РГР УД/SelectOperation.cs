...
namespace РГР_УД
{
    public partial class SelectOperation : Form
    {
        ...
        private void selectButton_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM airline WHERE airline_id = @value", DB.getConnection());

            command.Parameters.Add("@table", MySqlDbType.VarChar).Value = table;
            command.Parameters.Add("@attr", MySqlDbType.VarChar).Value = attr;
            command.Parameters.Add("@condAttr", MySqlDbType.VarChar).Value = condAttr;
